    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="mx-auto mt-8 max-w-lg rounded-2xl border border-dashed border-border-strong bg-white/30 px-6 py-4 backdrop-blur-sm"
        >
        ...
        >
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 rounded-full border border-border-strong bg-white/50 px-8 py-3.5 text-sm font-medium text-text-primary backdrop-blur-md transition-all duration-300 hover:border-primary/40 hover:bg-white/80 hover:shadow-lg"
          >
            Contact Me
          </a>
        </motion.div>
