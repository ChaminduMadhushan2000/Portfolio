    ...
    >
      ...
      >
        ...
        >
          ...
          <br />
          <span className="text-text-secondary">Madhushan</span>
        </motion.h1>
        ...
        <motion.div
          ...
          className="mx-auto mt-8 max-w-lg rounded-2xl border border-dashed border-border-strong bg-white/30 dark:bg-white/5 px-6 py-4 backdrop-blur-sm"
        >
        ...
        >
          ...
          <a
            href="/resume.pdf"
            download
            className="inline-flex items-center gap-2 rounded-full border border-border-strong bg-white/50 dark:bg-white/10 px-8 py-3.5 text-sm font-medium text-text-primary backdrop-blur-md transition-all duration-300 hover:border-primary/40 hover:bg-white/80 dark:hover:bg-white/15 hover:shadow-lg"
          >
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        >
          <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full border border-border-strong text-text-secondary transition-all hover:border-primary/40 hover:text-primary hover:bg-primary/5"
            aria-label="GitHub"
          >
        ...
        >
          <motion.div
            ...
            className="mx-auto flex h-10 w-6 items-start justify-center rounded-full border-2 border-primary/30 p-1"
          >
            <motion.div className="h-2 w-1 rounded-full bg-primary/50" />
          </motion.div>
        </motion.div>
      </div>
    </section>
